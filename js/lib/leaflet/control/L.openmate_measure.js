...
//	    this._map.off('moveend', this._onMoveEnd, this);
	...
	updateContent: function (labelText,subtext) {
		...
		this._container.style.left = "-13px";
	...
	finishContent: function (prefix , subtext) {
		...
		this._container.style.marginTop="-15px";
		this._container.style.left = "65px";
		this._container.innerHTML =prefix+' : <span class="leaflet-draw-tooltip-subtext">' + subtext + '</span> <a href="#" class="close"><img src=\"/js/lib/leaflet/control/measure_control/images/ic_tooltip_close.png\"/></a>' + '<br />' ;
		return this;
	},
